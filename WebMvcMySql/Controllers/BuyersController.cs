...
namespace WebMvcMySql.Controllers
{
    public class BuyersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Phone,RegistrationDate,CPF_CNPJ,BirthDate,StateDoc,IsBlocked,IsFree")] Buyer buyer)
        {
            //buyer.PersonTypeId = (PersonTypeEnum)1;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Phone,RegistrationDate,CPF_CNPJ,BirthDateStateDoc,IsBlocked,IsFree")] Buyer buyer)
        {
            if (id != buyer.Id)
            {
                return NotFound();
